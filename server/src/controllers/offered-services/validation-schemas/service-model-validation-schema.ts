...
import { SingleServiceBody } from '../types';

const serviceModelValidationSchema: yup.ObjectSchema<SingleServiceBody> = yup.object({
  title: yup.string()
...
export default serviceModelValidationSchema;
